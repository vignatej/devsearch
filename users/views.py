...
def createSkill(request):
    ...
    if request.method=='POST':
        ...
        if form.is_valid():
            ...
            skill.owner=profile
            skill.save()
            messages.success(request,"skill was created sucessfuly")
            return redirect('account')
    context={'form':form}
...
def updateSkill(request,pk):
    ...
    if request.method=='POST':
        ...
        if form.is_valid():
            form.save()
            messages.success(request,"skill was updated sucessfuly")
            return redirect('account')
    context={'form':form}
    return render(request,'users/skill_form.html',context)
...
def createMessage(request,pk):
    ...
    if request.method=='POST':
        ...
        if form.is_valid():
            ...
            message.save()
            messages.success(request,"your msg was sucessfully sent")
